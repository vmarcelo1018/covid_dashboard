...
daily_raw = read_csv("WHO COVID-19 Daily Data.csv")
...
age_raw = read_csv("WHO COVID-19 Monthly Deaths by Age.csv")
...
vax_raw = read_csv("COVID Vaccine Uptake 2021-2023.csv")
