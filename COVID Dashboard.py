...
daily_raw = pd.read_csv("WHO_COVID-19_Daily_Data.csv")
...
age_raw = pd.read_csv("WHO_COVID-19_Monthly_Deaths_by_Age.csv")
...
vax_raw = pd.read_csv("COVID_Vaccine_Uptake_2021-2023.csv")
